  ...
  ({ className, ...props }, ref) => (
    <div ref={ref} className={cn("", className)} {...props}>
      ...
      <section className='grid grid-cols-3 gap-8 dark:bg-black bg-white border rounded-lg p-5'>
        <figure style={{ clipPath: 'url(#clip-pattern)' }} className="relative aspect-[4/5] overflow-hidden">
          <Image
            src='https://images.unsplash.com/photo-1601758228041-f3b2795255f1?w=500&h=625&fit=crop'
            alt='Cão sendo adestrado'
            fill
            className='transition-all duration-300 object-cover hover:scale-110'
            unoptimized
          />
        </figure>
        <figure style={{ clipPath: 'url(#clip-pattern1)' }} className="relative aspect-[4/5] overflow-hidden">
          <Image
            src='https://images.unsplash.com/photo-1601758228041-f3b2795255f1?w=500&h=625&fit=crop'
            alt='Cão sendo adestrado'
            fill
        ...
        <figure style={{ clipPath: 'url(#clip-pattern2)' }} className="relative aspect-[4/5] overflow-hidden">
          <Image
            src='https://images.unsplash.com/photo-1601758228041-f3b2795255f1?w=500&h=625&fit=crop'
            alt='Cão sendo adestrado'
            fill
        ...
        <figure style={{ clipPath: 'url(#clip-pattern3)' }} className="relative aspect-[4/5] overflow-hidden">
          <Image
            src='https://images.unsplash.com/photo-1601758228041-f3b2795255f1?w=500&h=625&fit=crop'
            alt='Cão sendo adestrado'
            fill
        ...
        <figure style={{ clipPath: 'url(#clip-pattern4)' }} className="relative aspect-[4/5] overflow-hidden">
          <Image
            src='https://images.unsplash.com/photo-1601758228041-f3b2795255f1?w=500&h=625&fit=crop'
            alt='Cão sendo adestrado'
            fill
        ...
        <figure style={{ clipPath: 'url(#clip-pattern5)' }} className="relative aspect-[4/5] overflow-hidden">
          <Image
            src='https://images.unsplash.com/photo-1601758228041-f3b2795255f1?w=500&h=625&fit=crop'
            alt='Cão sendo adestrado'
            fill
        ...
        <figure style={{ clipPath: 'url(#clip-pattern6)' }} className="relative aspect-[4/5] overflow-hidden">
          <Image
            src='https://images.unsplash.com/photo-1601758228041-f3b2795255f1?w=500&h=625&fit=crop'
            alt='Cão sendo adestrado'
            fill
        ...
        <figure style={{ clipPath: 'url(#clip-pattern7)' }} className="relative aspect-[4/5] overflow-hidden">
          <Image
            src='https://images.unsplash.com/photo-1601758228041-f3b2795255f1?w=500&h=625&fit=crop'
            alt='Cão sendo adestrado'
            fill
        ...
        <figure style={{ clipPath: 'url(#clip-pattern8)' }} className="relative aspect-[4/5] overflow-hidden">
          <Image
            src='https://images.unsplash.com/photo-1601758228041-f3b2795255f1?w=500&h=625&fit=crop'
            alt='Cão sendo adestrado'
            fill
      ...
      <section className='dark:bg-black mt-4 bg-white border rounded-lg p-5'>
        <figure className='relative group w-full aspect-[10/4]'>
          <svg
          ...
          >
            ...
            <image
              ...
              width={'100%'}
              height={'100%'}
              href='https://images.unsplash.com/photo-1601758228041-f3b2795255f1?w=1200&auto=format&fit=crop'
            />
          </svg>
        </figure>
      </section>
