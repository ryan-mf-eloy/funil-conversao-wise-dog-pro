...
export function AppStoreButton({
  ...
  return (
    <Button
      ...
      {...props}
    >
      <AppleIcon className="!w-8 !h-8 flex-shrink-0 group-hover:scale-110 group-hover:rotate-12 transition-all duration-300" />
      <div className="text-left flex flex-col items-start justify-center pr-4">
        <span className="text-sm leading-none tracking-tighter font-medium">
          Download on the
        </span>
